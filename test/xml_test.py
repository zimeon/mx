#!/usr/bin/env python
#
# Version of https://github.com/edsu/pymarc/blob/master/test/xml_test.py 
# modified to deal with batch.xml.gz instead of batch.xml. Seems to work
# fine everywhere... [Simeon/2014-09-19]
#
import sys
import unittest
import gzip
...
class XmlTest(unittest.TestCase):
    ...
    def test_parse_to_array(self):
        fh = gzip.open('test/batch.xml.gz','rb')
        records = pymarc.parse_xml_to_array(fh)
